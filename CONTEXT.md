...
| **Auto-translate**             | The server action that fills the display locales from a source field. For **authored content** the source is Dutch; for **quoted content** (reviews) it is the review's **original locale**.                                                                                                                                                          |
